...
Client::Client (const std::string& file,const char letter) :                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            (file,letter,typesClientConections::CLIENT_CONECTION){
    this->pid = getpid();
    log(CLIENT_NAME + " " + to_string(this->pid) + " : Inicializador cliente con id: ",INFORMATION);
}
